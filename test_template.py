...
data = {
    ...
    "community_time_days": [
        ...
        ["Tue", "Tutor Time", "Tutor Time", "Tutor Time", "Tutor Time"],
        [
            "Wed",
            "Academic Assembly: PPE Recongition (Gym)",
            "Dean's Forum (Auditorium)",
            "Zhi Xing PRE-trip (various location)",
            "Health Talk 4\xa0 (Auditorium)",
        ],
        ["Thu", "Tutor Time", "Tutor Time", "Tutor Time", "Tutor Time"],
    ],
